...
- AUTO_CAL ist als praxisorientierter Feld-Workflow verbessert (Stereo + tolerant um 1 kHz + Reject-Gründe + längere Blockmessung + Freshness-Fenster/Latching statt Poll-Exactness), bleibt aber bis zur erneuten Messung auf echter Hardware weiterhin als **experimentell/feldzuvalidieren** markiert.
